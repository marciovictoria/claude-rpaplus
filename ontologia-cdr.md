...
- **Lente Brasil:** CAC em reais, custo de mídia paga BR, regras de publicidade de
  apostas/capitalização.
...
- **Brasil:** ângulo 3G/Jorge Paulo Lemann (custo base zero, dono, meritocracia) +
  **lente regulatória**: Banco Central, SUSEP/SECAP, regras de loterias e apostas,
  CVM, carga tributária.
...
- **Lente Brasil/ética:** LGPD/ANPD, uso responsável de dados de jogadores,
  exposição reputacional no setor de apostas.
